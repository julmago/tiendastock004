...
csrf_check();
$seller = require_seller_kind($pdo, 'mayorista', '/vendedor/login.php');
...
(function() {
  ...
  function fetchResults(query) {
    ...
    fetch('/vendedor/mayorista/api/provider_products_search.php?' + params.toString(), {
  ...
  function linkProviderProduct(linkedId, rowEl) {
    ...
    fetch('/vendedor/mayorista/api/link_product.php', {
      method: 'POST',
      headers: {
